// Inline stroke icons (Lucide-style, 24px grid, currentColor) — emoji rendered differently
// on every platform and looked out of place next to the rest of the UI.
const PATHS = {
  ...
  beer: '<path d="M5 9v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V9"/><path d="M17 11h1.5a2.5 2.5 0 0 1 0 5H17"/><path d="M9 12.5v5"/><path d="M13 12.5v5"/><path d="M5.5 9a2.5 2.5 0 0 1-.4-4.97A3 3 0 0 1 10 3a3 3 0 0 1 4.9.1A2.5 2.5 0 1 1 16.5 9Z"/>',
...
/** Fills every static `<… data-icon="name">` placeholder in the page markup. */
